...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            double ans = 0;
            if (endIndexExclusive - startIndexInclusive <= 200000) {
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks - 1; i++){
            ...
            int end = getChunkEndExclusive(i, numTasks, input.length) - 1;
        ...
        int end = getChunkEndExclusive(numTasks - 1, numTasks, input.length) - 1;
        ReciprocalArraySumTask task = new ReciprocalArraySumTask(start, end, input);
        task.compute();
